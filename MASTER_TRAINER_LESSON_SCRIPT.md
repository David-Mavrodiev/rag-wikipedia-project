...
| **7:00–8:30**<br>VERIFY *(never cut)* | "This is the part people skip. I read the diff myself, then I run the tests." | `git diff` → read one hunk aloud.<br>`.\.venv\Scripts\python.exe -m pytest -q` → **285 passing**. |
